      ...
      <Card className="max-w-lg">
        ...
        <CardContent className="space-y-3">
          ...
          {updating ? (
            ...
            <Button variant="outline" className="w-full" onClick={handleCheckUpdate} disabled={checking}>
              <RefreshCwIcon className={`size-4 ${checking ? "animate-spin" : ""}`} />{checking ? "检查中..." : "检查更新"}
            </Button>
          )}
        </CardContent>
      </Card>
